[![tests](https://github.com/ddev/ddev-ddev-vnc/actions/workflows/tests.yml/badge.svg)](https://github.com/ddev/ddev-ddev-vnc/actions/workflows/tests.yml) ![project is maintained](https://img.shields.io/maintenance/yes/2024.svg)

# ddev-ddev-vnc <!-- omit in toc -->

* [What is ddev-ddev-vnc?](#what-is-ddev-ddev-vnc)
* [Components of the repository](#components-of-the-repository)
* [Getting started](#getting-started)
* [How to debug in Github Actions](#how-to-debug-tests-github-actions)

## What is ddev-ddev-vnc?
...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.ddev-vnc.yaml](docker-compose.ddev-vnc.yaml) file.
...
3. Globally replace "ddev-vnc" with the name of your add-on.
4. Add the files that need to be added to a DDEV project to the repository. For example, you might replace `docker-compose.ddev-vnc.yaml` with the `docker-compose.*.yaml` for your recipe.
